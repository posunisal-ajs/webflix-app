    ...
    <div class="modal-content">
      ...
      <form action="editarUsuario" method="post" class="d-inline-block">
	      <div class="modal-body modal-body-bg">
             ...
             <div class="form-group">
               <input type="password" placeholder="Senha atual" name="senhaAtual" class="form-control fwdSenhaEdit"/>
             </div>
             <div class="form-group">
               <input type="password" placeholder="Nova senha" name="senha" class="form-control fwdSenhaEdit"/>
             </div>
             <div class="form-group">
               <input type="password" placeholder="Corfirmar nova senha" name="senhaNova" class="form-control fwdSenhaEdit"/>
             </div>
	      </div>
	      <div class="modal-footer">
				<input type="hidden" name="id" class="fwdId" value=""/>
