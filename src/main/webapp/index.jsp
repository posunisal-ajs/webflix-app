			        ...
			        <div class="col-12 col-xs-12 col-md-12 col-lg-12 text-center box-login">        	
			            <div class="form">
			                ...
			                <form action="login" method="post">
								...
								<div class="form-group">
									<input type="password" placeholder="Digite uma senha" name="pass" class="form-control"/>
								</div>
								<button type="submit" class="btn btn__blue--nav font-button-18 pull-right mt-4 mb-4">ENTRAR</button>
							</form>
			            </div>
			          </div>
			         </div>
